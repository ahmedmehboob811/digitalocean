  ...
  return (
    <div className="flex flex-col h-full max-w-4xl mx-auto">
        <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground dark:text-dark-muted-foreground">Ask me anything about your subjects!</p>
        </div>
        ...
        <div className="flex-1 p-6 space-y-4 overflow-y-auto">
          {messages.map((msg) => (
            <div key={msg.id} className={`flex items-end gap-2 ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
              ...
              <div className={`max-w-md p-3 rounded-lg ${msg.sender === 'user' ? 'bg-primary text-primary-foreground dark:bg-dark-primary dark:text-dark-primary-foreground' : 'bg-secondary dark:bg-dark-secondary'}`}>
